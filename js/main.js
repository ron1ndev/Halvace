	...
	function initProductOnPage(category){
		...
		if(furnitureId || LightingId || decorId){
			...
			const data = {
				...
				'Lighting':[
					{
						"name": "Светильник «Волна Света»",
						"price": "12 500",
						"img": "img/data/light/1.webp",
						"id": "0",
						"decr": "Настольный светильник с изогнутыми линиями, напоминающий морские волны. Создаёт мягкое, рассеянное освещение для уютной атмосферы."
					  },
					  {
						"name": "Светильник «Нордический Куб»",
						"price": "8 200",
						"img": "img/data/light/2.webp",
						"id": "1",
						"decr": "Прямоугольный светильник в скандинавском стиле, добавляющий мягкий свет и стиль в современный интерьер."
					  },
					  {
						"name": "Светильник «Гексагон Амбер»",
						"price": "10 900",
						"img": "img/data/light/3.webp",
						"id": "2",
						"decr": "Настольная лампа с шестигранным корпусом, отбрасывающая тёплый свет для создания уютной атмосферы."
					  },
					  {
						"name": "Светильник «Ретро Лампа»",
						"price": "5 900",
						"img": "img/data/light/4.webp",
						"id": "3",
						"decr": "Лампа с винтажной лампочкой на прочной подставке, добавляющая интерьеру элемент ретро-шарма."
					  },
					  {
						"name": "Светильник «Сетчатый Свет»",
						"price": "7 400",
						"img": "img/data/light/5.webp",
						"id": "4",
						"decr": "Стильный светильник в металлической сетке, создающий интересные тени и добавляющий индустриальный стиль."
					  },
					  {
						"name": "Светильник «Тёплое Пламя»",
						"price": "9 800",
						"img": "img/data/light/6.webp",
						"id": "5",
						"decr": "Компактный светильник с цилиндрическим стеклом, внутри которого теплый свет, напоминающий огонь."
					  },
					  {
						"name": "Светильник «Симфония Орнаментов»",
						"price": "6 200",
						"img": "img/data/light/7.webp",
						"id": "6",
						"decr": "Настольный светильник с изящным орнаментом на плафоне, создающим красивые узоры при освещении."
					  },
					  {
						"name": "Светильник «Сфера Баланса»",
						"price": "4 600",
						"img": "img/data/light/8.webp",
						"id": "7",
						"decr": "Минималистичный светильник с простой стойкой, отлично подходящий для освещения рабочего места."
					  },
					  {
						"name": "Светильник «Восточная Звезда»",
						"price": "11 500",
						"img": "img/data/light/9.webp",
						"id": "8",
						"decr": "Лампа с резным восточным узором, отбрасывающая причудливые тени на стены."
					  },
					  {
						"name": "Светильник «Цветочный Бутик»",
						"price": "9 300",
						"img": "img/data/light/10.webp",
						"id": "9",
						"decr": "Уникальный светильник в форме цветка с лепестками из дерева, создающий мягкое природное освещение."
					  },
					  {
						"name": "Светильник «Ночной Свет»",
						"price": "6 700",
						"img": "img/data/light/11.webp",
						"id": "10",
						"decr": "Мягкий ночник с тканевым абажуром, идеальный для прикроватной тумбочки."
					  },
					  {
						"name": "Светильник «Линия Современности»",
						"price": "7 800",
						"img": "img/data/light/12.webp",
						"id": "11",
						"decr": "Настенный светильник с двумя параллельными линиями света, идеально подходящий для хай-тек интерьера."
					  }
				  ],
				  'decor':[
					{
						"name": "Ваза «Изумрудная Грация»",
						"price": "3 200",
						"img": "img/data/decor/1.webp",
						"id": "0",
						"decr": "Элегантная ваза глубокого изумрудного цвета, придающая интерьеру свежесть и роскошь."
					  },
					  {
						"name": "Растение «Зеленый Оазис»",
						"price": "2 400",
						"img": "img/data/decor/2.webp",
						"id": "1",
						"decr": "Искусственное растение в белом горшке, добавляющее в дом ощущение живой природы."
					  },
					  {
						"name": "Кресло «Лаунж Комфорт»",
						"price": "18 700",
						"img": "img/data/decor/3.webp",
						"id": "2",
						"decr": "Современное кресло с металлическими элементами и мягкими подушками, идеально для зоны отдыха."
					  },
					  {
						"name": "Ваза «Красная Фантазия»",
						"price": "3 500",
						"img": "img/data/decor/4.webp",
						"id": "3",
						"decr": "Необычная ваза с яркими красными листьями, привносящая экзотический акцент в любой интерьер."
					  },
					  {
						"name": "Зеркало «Скандинавский Минимализм»",
						"price": "12 000",
						"img": "img/data/decor/5.webp",
						"id": "4",
						"decr": "Большое настенное зеркало в минималистичном стиле, визуально расширяющее пространство."
					  },
					  {
						"name": "Цветочная композиция «Оранжевое Настроение»",
						"price": "1 800",
						"img": "img/data/decor/6.webp",
						"id": "5",
						"decr": "Изысканная композиция из искусственных цветов в прозрачной вазе, добавляющая тепло и яркость."
					  },
					  {
						"name": "Полка «Скандинавский Уют»",
						"price": "4 600",
						"img": "img/data/decor/7.webp",
						"id": "6",
						"decr": "Белая полка с минималистичным дизайном, идеально подходит для организации предметов на кухне или в гостиной."
					  },
					  {
						"name": "Полка «Настенная Коллекция»",
						"price": "5 200",
						"img": "img/data/decor/8.webp",
						"id": "7",
						"decr": "Настенная полка с декором в нейтральных тонах, создающая уютный уголок с книгами и растениями."
					  }
				  ]
			};
